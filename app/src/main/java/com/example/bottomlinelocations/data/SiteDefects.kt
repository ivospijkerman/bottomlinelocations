    ...
    companion object {
        fun getAll(): List<SiteDefects> {
            return listOf(
                ...
                SiteDefects(6, "Esso De Oever", "Kerkstraat 343", "","Telemetry of site is defect, this needs to be repaired"  ,"2020-10-23 1200"),
                SiteDefects(7, "Esso De Oever", "Kerkstraat 343", "","Telemetry of site is defect, this needs to be repaired"  ,"2020-10-24 1200"),
                SiteDefects(8, "Esso De Oever", "Kerkstraat 343", "","Telemetry of site is defect, this needs to be repaired"  ,"2020-10-24 1200")
            )
        }
